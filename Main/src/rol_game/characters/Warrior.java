...
public class Warrior extends Characters{
     ...
     */
    public Warrior(String name, int lifes, int gold, int v, int x, int y, JLabel labelCharacter) {
    ...
    public String showCharacterUp(){
        return "src/images/warrior/warrior_up.gif";
    }
     ...
     */
    @Override
    public String showCharacterDown(){return  "src/images/warrior/warrior_down.gif";}
    ...
    public String showCharacterLeft(){
        return "src/images/warrior/warrior_left.gif";
    }
    ...
    public String showCharacterRight(){
        return "src/images/warrior/warrior_right.gif";
    }
