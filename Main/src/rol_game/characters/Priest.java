...
public class Priest extends Characters {
     ...
     */
    public Priest(String name, int lifes, int gold, int v, int x, int y, JLabel labelCharacter) {
    ...
    public String showCharacterUp(){
        return characterUp = "src/images/priest/priest_up.gif";
    }
    ...
    public String showCharacterDown(){
        return characterUp = "src/images/priest/priest_down.gif";
    }
    ...
    public String showCharacterLeft(){
        return characterUp = "src/images/priest/priest_left.gif";
    }
    ...
    public String showCharacterRight(){
        return characterUp = "src/images/priest/priest_right.gif";
    }
